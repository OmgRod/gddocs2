...
> **The GD Docs Project is maintained by [Wylie](https://github.com/Wyliemaster) and [OmgRod](https://github.com/OmgRod) and is backed by [GD Programming](https://discord.gg/gd-programming-646101505417674758) which is owned by [SMJS](https://github.com/SMJSGaming)**
