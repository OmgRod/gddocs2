...
> Geometry Dash uses [XOR Cipher](/topics/encryption/xor) combined with [base64 encoding](/topics/encryption/base64) to protect various strings within the client. Multiple Keys are used to protect different aspects of the game
...
> there are **two** ways Geometry Dash applies [XOR Cipher](/topics/encryption/xor) to strings - **Static** and **Cycled**
>
