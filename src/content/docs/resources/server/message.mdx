...
| 4   | title      | **String** | The title encoded in [Base64](/topics/encryption/base64)
| 5   | messageContent | **String** | The message which has been [Xor'd](/topics/encryption/xor) with a key of `14251` and then encoded in [base64](/topics/encryption/base64)
