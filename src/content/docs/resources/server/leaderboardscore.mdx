---
title: 'Server Leaderboard Score Resource'
template: doc
---
...
- The key structure that leaderboards follow are exactly the same as the structure used for [Player Profiles](/resources/server/user)  