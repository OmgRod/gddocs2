---
title: 'Server Restore Resource'
template: doc
---

## RestoreGJItems

`Restore` was a feature used in Geometry dash from versions `1.7 - 2.0` and it was used as an alternative to the [Account System](resources/topics/accounts) that is currently used as of 2.206
