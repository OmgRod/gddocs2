---
title: 'Music Library format'
template: doc
---

The Music Library is stored in your save directory as `musiclibrary.dat`. To learn how to retreive it from the servers, refer to [this page](/endpoints/songs/musiclibrary).

To decode musiclibrary.dat, you need to [Base64](/topics/encryption/base64) URL-Safe decode it and [Zlib](/topics/encryption/zip) inflate it.
