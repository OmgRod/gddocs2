---
title: 'Client Level String Resource'
template: doc
---
...
| 30  | Easing                               | **[Easing](enumerations)**                   | the Easing type of the effect of a trigger                                         |
...
| 48  | Pulse Mode                           | **[Pulse Mode](enumerations)**               | the Pulse Mode property of the Pulse trigger                                       |
...
| 52  | Pulse Target Type                    | **[Pulse Target Type](enumerations)**        | the Target Type property of the Pulse trigger                                      |
...
| 79  | Pickup Mode                          | **[Pickup Item Mode](enumerations)**         | the Pickup Mode property of the Pickup Item                                        |
...
| 82  | Toggle Mode                          | **[Touch Toggle Mode](enumerations)**        | the Toggle Mode property of the Touch trigger                                      |
...
| 88  | Comparison                           | **[Instant Count Comparison](enumerations)** | the Comparison property of the Instant Count trigger                               |
...
| 101 | Target Pos Coordinates               | **[Target Pos Coordinates](enumerations)**   | the Target Pos Coordinates property of the Move trigger                            |
