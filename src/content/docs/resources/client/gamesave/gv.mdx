...
Game Variables (gvs) are found inside of the [ValueKeeper](/resources/client/gamesave/valueKeeper) Dictionary and each gv value corresponds with a specific ingame setting
