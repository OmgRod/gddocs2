...
| Key | description |
|:----|:------------|
| kCEK 4 | [level data](resources/client/level) |
...
| kCEK 4 | The Encoder key which contains [level data](resources/client/level)
...
| Key | description |
|:----|:------------|
| kCEK 10 | [level data](resources/client/gamesave/template) |
...
| Key | description |
|:----|:------------|
| kCEK 12 | [level data](resources/client/gamesave/list) |