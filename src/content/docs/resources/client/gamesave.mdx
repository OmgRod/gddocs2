---
title: 'Client Gamesave Resource'
template: doc
---

## CCGameManager.dat

Your CCGameManager.dat File contains a lot of information regarding your account. it is encrypted using [Xor](/topics/encryption/xor) with a key of 11 / 0xB, [url-Safe Base64](/topics/encryption/base64) and [Gzip](/topics/encryption/zip) and is in the [XML](https://en.wikipedia.org/wiki/XML) format
...
| playerFrame| [Icon](enumerations)| The ID of the player's cube |
| playerShip| [Icon](enumerations)| The ID of the player's ship |
| playerBall| [Icon](enumerations)| The ID of the player's ball |
| playerBird| [Icon](enumerations)| The ID of the player's UFO |
| playerDart| [Icon](enumerations)| The ID of the player's wave |
| playerRobot| [Icon](enumerations)| The ID of the player's robot |
| playerSpider| [Icon](enumerations)| The ID of the player's spider |
| playerSwing| [Icon](enumerations)| The ID of the player's swing |
| playerColor| [Icon](enumerations)| The ID of the player's primary color |
| playerColor2| [Icon](enumerations)| The ID of the player's secondary color |
| playerColor3| [Icon](enumerationsThe ID of the player's glow color, -1 if same as secondary color |
| playerStreak| [Icon](enumerations)| The ID of the player's trail |
...
| playerIconType| [Icon](enumerations)| The Index of the player's IconType |
...
| resolution| [resolution](/resources/client/gamesave/enums) | The games resolution  |
...
| dpad01 | [Platformer UI](/resources/client/gamesave/dpad) | Platformer UI configuration #1 |
| dpad02 | [Platformer UI](/resources/client/gamesave/dpad) | Platformer UI configuration #2 |
| dpad03 | [Platformer UI](/resources/client/gamesave/dpad) | Platformer UI configuration #3 |
| dpad04 | [Platformer UI](/resources/client/gamesave/dpad) | Platformer UI configuration #4, however it's missing the last 5 options |
| dpad05 | [Platformer UI](/resources/client/gamesave/dpad) | Platformer UI configuration #5, however it's missing the last 5 options |
| dpadLayout01 | [Platformer UI](/resources/client/gamesave/dpad) | Default UI? |
| dpadLayoutDual01 | [Platformer UI](/resources/client/gamesave/dpad) | 2 platformer UIs separated by `;`, then 2 gamepad placements, also separated by `;`
...
| gameCenterEnabled | Bool | Whether the Game Center (iOS) was enabled. Moved to valueKeeper::[gv_0034](/resources/client/gamesave/gv) |
...
| autoRetryLevel | Bool | If the level automatically restarts after death. Moved to valueKeeper::[gv_0026](/resources/client/gamesave/gv) |
...
| Key     | Type | description |
| :-------| :--- | :-----------|
| [GLM_01](/resources/client/gamesave/GLM#GLM_01) | [Level](/resources/client/level)| All Official Levels you have progress on are stored here |
| [GLM_02](/resources/client/gamesave/GLM#GLM_02) | [level](/resources/client/level) | Uploaded levels - before the account System |
| [GLM_03](/resources/client/gamesave/GLM#GLM_03) | [Level](/resources/client/level)| online levels played|
| [GLM_04](/resources/client/gamesave/GLM#GLM_04) | rating| Shows what levels you have rated. was removed after 1.9 |
| [GLM_06](/resources/client/gamesave/GLMM_06) | AccountIDs| The AccountIDs of all creators you follow    |
| [GLM_07](/resources/client/gamesave/GLM#GLM_07) | levelID| Levels played in last session |
| [GLM_08](/resources/client/gamesave/GLM#GLM_08) | filters | Search Filters States |
| [GLM_09](/resources/client/gamesave/GLM#GLM_09) | filters | Search Filters for Online Levels    |
| [GLM_10](/resources/client/gamesave/GLM#GLM_10) | [Level](/resources/client/levelCompleted dailies |
| [GLM_11](/resources/client/gamesave/GLM#GLM_11) | Integer| Current Daily ID |
| [GLM_12](/resources/client/gamesave/GLMM_12) | likes | Something Related to likes |
| [GLM_13](/resources/client/gamesave/GLM#GLM_13) | levelID | All levels you submitted a rating on |
| [GLM_14](/resources/client/gamesave/GLMM_14) | reportedLevels| A dictionary of all levels you have reported|
| [GLM_15](/resources/client/gamesave/GLM#GLM_15) | levelID | all Demon levels you have submitted a rating for |
| [GLM_16](/resources/client/gamesave/GLM#GLM_16) | [Level](/resources/client/level)| All the levels found in the Gauntlets that you have progress on are stored in here |
| [GLM_17](/resources/client/gamesave/GLM#GLM_17) | integer| Current Weekly ID |
| [GLM_18](/resources/client/gamesave/GLM#GLM_18) | Folder | The Folder Names for saved levels |
| [GLM_19](/resources/client/gamesave/GLM#GLM_19) | Folder | The Folder names for Local Levels |
| [GLM_20](/resources/client/gamesave/GLM#GLM_20) | [Templates](/resources/client/gamesave/template) | Your Smart Templates |
...
| [GS_12](/resources/client/gamesave/GS_Value?id=gs_12)| Contains [Quests](resources/client/gamesave/quests)|
| [GS_14](/resources/client/gamesave/GS_Value#GS_14)| Daily/Challenges rewards |
| [GS_15](/resources/client/gamesave/GS_Value?id=gs_15)| Contains Upcoming [Quests](resources/client/gamesave/quests)|
...
| GJA_005 | Your password with [GJP2](/topics/gjp) Encryption|

### LLM

| Key | Value|
| :-- |:-----------|
| LLM_01 | Local [Levels](/resources/client/level) |
| LLM_02 | Hardcoded to `binaryVersion`|
| LLM_03 | Local [Lists](/resources/client/gamesave/list) |

### MDLM

| Key | Value |
|:----|:------|
| MDLM_001 | Dictionary of [SongInfoObject](/resources/server/song) |
